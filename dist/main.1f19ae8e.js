...
var $itemList = $('.firstList');
var $lastitem = $itemList.find('.last');
...
var render = function render() {
  ...
  hashMap.forEach(function (node, index) {
    var $item = $("<div class=\"item\">\n                <div class=\"site\">".concat(node.logo, "</div>\n                <a href=\"").concat(simplifyUrl(node.url), "\">").concat(simplifyUrl(node.url), "</a>\n                <div class=\"close\">\n                <svg class=\"close-icon\">\n                    <use xlink:href=\"#icon-guanbi\"></use>\n                </svg>\n                </div>\n            </div>")).insertBefore($lastitem);
...
$('.addButton').on('click', function () {
  var url = window.prompt('添加经常访问的网址');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5226" + '/');
